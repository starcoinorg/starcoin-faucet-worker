...
docker run -d --name starcoin-faucet-worker \
    ...
    -e "STARCOIN_FAUCET_WORKER_SENDER_PRIVATE_KEYS_BARNARD=${STARCOIN_FAUCET_WORKER_SENDER_PRIVATE_KEYS_BARNARD}" \
    -e "STARCOIN_FAUCET_WORKER_SENDER_PRIVATE_KEYS_PROXIMA=${STARCOIN_FAUCET_WORKER_SENDER_PRIVATE_KEYS_PROXIMA}" \
    -e "STARCOIN_FAUCET_WORKER_SENDER_PRIVATE_KEYS_HALLEY=${STARCOIN_FAUCET_WORKER_SENDER_PRIVATE_KEYS_HALLEY}" \
